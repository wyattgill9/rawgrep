...
use crate::ext4::{
    ...
    EXT4_INODE_BLOCK_OFFSET,
    EXT4_INODE_FLAGS_OFFSET,
    EXT4_INODE_MODE_OFFSET,
    EXT4_INODE_SIZE_OFFSET,
    EXT4_INODE_SIZE_OFFSET_HIGH,
    EXT4_INODE_SIZE_OFFSET_LOW,
...
pub const _MAX_DIR_BYTE_SIZE: usize = 16 * 1024 * 1024; // @Tune
pub const _MAX_FILE_BYTE_SIZE: usize = 8 * 1024 * 1024; // @Tune
